...
export const DIRECT_LINK_VIP_DETAILS_URL =
  `${REPORT_ROOT}/#mainsection=virtualservers&virtualserver=${DIRECT_LINK_VIP_DETAILS_NAME}@bigip.xip.se`;
...
export const DIRECT_LINK_SEARCH_BY_VIP_NAME_URL =
  `${REPORT_ROOT}/#mainsection=virtualservers&name=${DIRECT_LINK_SEARCH_BY_VIP_NAME}`;

export const DIRECT_LINK_SEARCH_BY_IP_PORT = '10.10.10.2:443';
export const DIRECT_LINK_SEARCH_BY_IP_PORT_URL =
  `${REPORT_ROOT}/#mainsection=virtualservers&ipport=${DIRECT_LINK_SEARCH_BY_IP_PORT}`;

export const DIRECT_LINK_SEARCH_BY_POOL = 'loadbalancing-se';
export const DIRECT_LINK_SEARCH_BY_POOL_URL =
  `${REPORT_ROOT}/#mainsection=virtualservers&poolmembers=${DIRECT_LINK_SEARCH_BY_POOL}`;
