import IVirtualServer from '../../src/Interfaces/IVirtualServer';
import IPool from '../../src/Interfaces/IPool';
import IMonitor from '../../src/Interfaces/IMonitor';
...
describe('Pool details should render properly', () => {
  ...
  it('Should show the pool details table when clicking on a pool details link', () => {
    ...
    cy.get('div#firstlayerdiv table.pooldetailstable').eq(1).find('tbody tr').each((row, i) => {
      ...
      // TODO Need to refactor frontend/src/PoolDetails/translateStatus.ts before we can reliably check these
