...
__webpack_require__.d(__webpack_exports__, {
  h5: () => (/* binding */ renderLoadBalancer),
  Us: () => (/* binding */ siteData),
  fg: () => (/* binding */ updateLocationHash)
});

;// ./src/PoolDetails/translateStatus.ts
/** ********************************************************************************************************************
...
;// ./src/PoolDetails/selectMonitorInputText.ts
...
;// ./src/PoolDetails/parseMonitorRequestParameters.ts
...
;// ./src/PoolDetails/generateMonitorTests.ts
...
;// ./src/PoolDetails/showPoolDetails.ts
    ...
    if (matchingpool) {
        ...
        if (matchingMonitors.length > 0) {
            ...
            matchingMonitors.forEach(matchingMonitor => {
                const escapedSendString = escapeHtml(matchingMonitor.sendstring);
                const escapedReceiveString = escapeHtml(matchingMonitor.receivestring);
                const escapedDisableString = escapeHtml(matchingMonitor.disablestring);
                table += `
...
;// ./src/Constants/KnownDevices.ts
const KnownDevices = {
    A100: { hardwareType: 'blade', icon: 'images/deviceicons/viprion_4400.png', softwareVersions: [] },
    A107: { hardwareType: 'blade', icon: 'images/deviceicons/viprion_4400.png', softwareVersions: [] },
    A108: { hardwareType: 'blade', icon: 'images/deviceicons/viprion_4400.png', softwareVersions: [] },
    A109: { hardwareType: 'blade', icon: 'images/deviceicons/viprion_c2400.png', softwareVersions: [] },
    A110: { hardwareType: 'blade', icon: 'images/deviceicons/viprion_4400.png', softwareVersions: [] },
    A112: { hardwareType: 'chassis', icon: 'images/deviceicons/viprion_c2400.png', softwareVersions: [] },
    A113: { hardwareType: 'blade', icon: 'images/deviceicons/viprion_c2400.png', softwareVersions: [] },
    A114: { hardwareType: 'blade', icon: 'images/deviceicons/viprion_c4800.png', softwareVersions: [] },
    C102: {
        hardwareType: 'appliance',
        icon: 'images/deviceicons/1600.png',
        softwareVersions: ['9.4.5 - 9.4.8', '10.0.0 - 10.2.4', '11.0.0 - 11.5.4', '11.6.0 - 11.6.1', '12.0.0 - 12.1.2'],
    },
    C103: {
        hardwareType: 'appliance',
        icon: 'images/deviceicons/3600.png',
        softwareVersions: ['9.4.5 - 9.4.8', '10.0.0 - 10.2.4', '11.0.0 - 11.5.4', '11.6.0 - 11.6.1', '12.0.0 - 12.1.2'],
    },
    C106: {
        hardwareType: 'appliance',
        icon: 'images/deviceicons/3900.png',
        softwareVersions: ['9.4.8', '10.1.0', '10.2.0 - 10.2.4', '11.0.0 - 11.5.5', '11.6.0 - 11.6.3', '12.0.0 - 12.1.3'],
    },
    C109: {
        hardwareType: 'appliance',
        icon: 'images/deviceicons/5000.png',
        softwareVersions: [
            '11.4.0 - 11.5.5', '11.6.0 - 11.6.3', '12.0.0 - 12.1.3', '13.0.0 - 13.1.0',
            '11.4.1 HF3 - 11.5.5', '11.6.0 - 11.6.3', '12.0.0 - 12.1.3', '13.0.0 - 13.1.0',
        ],
    },
    C112: {
        hardwareType: 'appliance',
        icon: 'images/deviceicons/2x00.png',
        softwareVersions: ['11.2.1 - 11.6.3', '12.0.0 - 12.1.3', '13.0.0 - 13.1.0'],
    },
    C113: {
        hardwareType: 'appliance',
        icon: 'images/deviceicons/4000.png',
        softwareVersions: ['11.2.1 - 11.5.5', '11.6.0 - 11.6.3', '12.0.0 - 12.1.3', '13.0.0 - 13.1.0'],
    },
    C114: {
        icon: 'images/deviceicons/2x00.png',
        softwareVersions: ['11.4.0 HF2 - 11.6.3', '12.0.0 - 12.1.3', '13.0.0 - 13.1.0'],
    },
    C115: {
        icon: 'images/deviceicons/i4000.png',
        softwareVersions: ['12.1.1 HF2 - 12.1.3', '13.0.0 - 13.1.0'],
    },
    C116: {
        icon: 'images/deviceicons/i10000.png',
        softwareVersions: ['12.1.1 HF2 - 12.1.3', '13.0.0 - 13.1.0'],
    },
    C117: {
        icon: 'images/deviceicons/i2000.png',
        softwareVersions: ['12.1.3'],
    },
    C118: {
        icon: 'images/deviceicons/i7000.png',
        softwareVersions: ['12.1.1 HF2 - 12.1.3', '13.0.0 - 13.1.0'],
    },
    C119: {
        icon: 'images/deviceicons/i5000.png',
        softwareVersions: ['12.1.1 HF2 - 12.1.3', '13.0.0 - 13.1.0'],
    },
    C123: {
        icon: 'images/deviceicons/i10000.png',
        softwareVersions: ['12.1.3', '13.1.0'],
    },
    D104: {
        hardwareType: 'appliance',
        icon: 'images/deviceicons/6900.png',
        softwareVersions: [
            '9.4.6 - 9.4.8', '10.0.0 - 10.2.4', '11.0.0 - 11.5.5', '11.6.0 - 11.6.3', '12.0.0 - 12.1.3',
            '9.4.7 - 9.4.8', '10.0.0 - 10.2.4', '11.0.0 - 11.5.5', '11.6.0 - 11.6.3', '12.0.0 - 12.1.3', '13.0.0 - 13.1.0',
            '11.0.0 - 11.5.5', '11.6.0 - 11.6.3', '12.0.0 - 12.1.3',
        ],
    },
    D106: {
        hardwareType: 'appliance',
        icon: 'images/deviceicons/89x0.png',
        softwareVersions: ['9.4.7 - 9.4.8', '10.0.0 - 10.2.4', '11.0.0 - 11.5.5', '11.6.0 - 11.6.3', '12.0.0 - 12.1.3'],
    },
    D107: {
        hardwareType: 'appliance',
        icon: 'images/deviceicons/89x0.png',
        softwareVersions: [
            '10.2.0 - 10.2.4', '11.0.0 - 11.5.5', '11.6.0 - 11.6.3', '12.0.0 - 12.1.3',
            '10.2.2 - 10.2.4', '11.0.0 - 11.5.5', '11.6.0 - 11.6.3', '12.0.0 - 12.1.3',
        ],
    },
    D110: {
        hardwareType: 'appliance',
        icon: 'images/deviceicons/7x00.png',
        softwareVersions: [
            '11.4.0 - 11.5.5', '11.6.0 - 11.6.3', '12.0.0 - 12.1.3', '13.0.0 - 13.1.0',
            '11.4.1 HF3 - 11.5.5', '11.6.0 - 11.6.3', '12.0.0 - 12.1.3', '13.0.0 - 13.1.0',
            '11.5.3 - 11.5.5', '12.0.0 - 12.1.3', '13.0.0 - 13.1.0',
        ],
    },
    D111: {
        hardwareType: 'appliance',
        icon: 'images/deviceicons/10x00.png',
        softwareVersions: ['11.5.5', '11.6.0 HF2 - 11.6.3', '12.0.0 - 12.1.3', '13.0.0 - 13.1.0'],
    },
    D112: {
        hardwareType: 'appliance',
        icon: 'images/deviceicons/10x00.png',
        softwareVersions: [
            '11.5.5', '11.6.0 HF2 - 11.6.3', '12.0.0 - 12.1.3', '13.0.0 - 13.1.0',
            '11.5.4 - 11.5.5', '11.6.0 HF2 - 11.6.3', '12.0.0 HF1 - 12.1.3', '13.0.0 - 13.1.0',
        ],
    },
    D113: {
        hardwareType: 'appliance',
        icon: 'images/deviceicons/10x00.png',
        softwareVersions: [
            '11.3.0 - 11.5.5', '11.6.0 - 11.6.3', '12.0.0 - 12.1.3', '13.0.0 - 13.1.0',
            '11.4.1 HF3 - 11.5.5', '11.6.0 - 11.6.3', '12.0.0 - 12.1.3', '13.0.0 - 13.1.0',
            '11.5.3 - 11.5.5', '11.6.1 - 11.6.3', '12.0.0 - 12.1.3', '13.0.0 - 13.1.0',
        ],
    },
    D114: { hardwareType: 'chassis', icon: 'images/deviceicons/viprion_c2400.png', softwareVersions: [] },
    D63: {
        hardwareType: 'appliance',
    ...
    D88: {
        hardwareType: 'appliance',
        icon: 'images/deviceicons/89x0.png',
        softwareVersions: ['9.4.0 - 9.4.8', '10.0.0 - 10.2.4', '11.0.0 - 11.1.0**'],
    },
    E101: {
        hardwareType: 'appliance',
        icon: 'images/deviceicons/11x00.png',
        softwareVersions: ['11.0.0 - 11.5.5', '11.6.0 - 11.6.3', '12.0.0 - 12.1.3', '13.0.0 - 13.1.0'],
    },
    E102: {
        hardwareType: 'appliance',
        icon: 'images/deviceicons/11x00.png',
        softwareVersions: ['10.2.0 - 10.2.4', '11.0.0 - 11.5.5', '11.6.0 - 11.6.3', '12.0.0 - 12.1.3', '13.0.0 - 13.1.0'],
    },
    F100: { hardwareType: 'chassis', icon: 'images/deviceicons/viprion_c2400.png', softwareVersions: [] },
    J100: { hardwareType: 'chassis', icon: 'images/deviceicons/viprion_4400.png', softwareVersions: [] },
    J102: { hardwareType: 'chassis', icon: 'images/deviceicons/viprion_4400.png', softwareVersions: [] },
    S100: { hardwareType: 'chassis', icon: 'images/deviceicons/viprion_c4800.png', softwareVersions: [] },
    Z100: { hardwareType: 'virtual', icon: 'images/deviceicons/virtual_edition.png', softwareVersions: [] },
    Z101: { hardwareType: 'virtual', icon: 'images/deviceicons/virtual_edition.png', softwareVersions: [] },
};
/* harmony default export */ const Constants_KnownDevices = (KnownDevices);

;// ./src/Constants/JSONFiles.ts
/**
...
/* harmony default export */ const getJSONFiles = (() => getJSONFiles_awaiter(void 0, void 0, void 0, function* () {
    ...
    const [pools, monitors, virtualservers, irules, datagroups, loadbalancers, preferences, certificates, devicegroups, asmpolicies, nat, state, policies, loggederrors,] = jsonResponses;
    const siteData = {
        NATdict: nat,
        ...
        policies: policies,
        knownDevices: Constants_KnownDevices,
...
const bigipreport_escapeHtml = (value) => String(value !== null && value !== void 0 ? value : '')
    .replace(/&/g, '&amp;')
    .replace(/</g, '&lt;')
    .replace(/>/g, '&gt;')
    .replace(/"/g, '&quot;')
    .replace(/'/g, '&#39;');
const buildJavascriptHref = (functionName, ...args) => (`javascript:${functionName}(${args
    .map((arg) => `decodeURIComponent('${encodeURIComponent(String(arg !== null && arg !== void 0 ? arg : ''))}')`)
    .join(',')});`);
const joinEscapedLines = (values = []) => values.map(bigipreport_escapeHtml).join('<br>');
...
function renderLoadBalancer(loadbalancer, type) {
    ...
    if (type === 'display') {
        return `<a href="https://${bigipreport_escapeHtml(loadbalancer)}" target="_blank" class="plainLink">${bigipreport_escapeHtml(balancer)}</a>`;
    }
    return bigipreport_escapeHtml(balancer);
}
function renderVirtualServer(loadbalancer, name, type) {
    const vsName = bigipreport_escapeHtml(name.replace(/^\/Common\//, ''));
    const escapedLoadBalancer = bigipreport_escapeHtml(loadbalancer);
    const escapedName = bigipreport_escapeHtml(name);
    const detailsHref = buildJavascriptHref('showVirtualServerDetails', name, loadbalancer);
    const editHref = `https://${escapedLoadBalancer}/tmui/Control/jspmap/tmui/locallb/virtual_server` +
        `/properties.jsp?name=${encodeURIComponent(name)}`;
    let result = '';
    if (type === 'display') {
        result += `<span class="adcLinkSpan"><a target="_blank" href="${editHref}">`;
        result += 'Edit</a></span>';
    }
    ...
    if (type === 'display') {
        result += `<a class="tooltip details-link" data-originalvirtualservername="${escapedName}"`;
        result += ` data-loadbalancer="${escapedLoadBalancer}"`;
        result += ` href="${detailsHref}">`;
    }
    result += vsName;
    if (type === 'display') {
...
function renderRule(loadbalancer, name, type) {
    const ruleName = bigipreport_escapeHtml(name.replace(/^\/Common\//, ''));
    const escapedLoadBalancer = bigipreport_escapeHtml(loadbalancer);
    const escapedName = bigipreport_escapeHtml(name);
    const detailsHref = buildJavascriptHref('showiRuleDetails', name, loadbalancer);
    const editHref = `https://${escapedLoadBalancer}/tmui/Control/jspmap/tmui/locallb/rule` +
        `/properties.jsp?name=${encodeURIComponent(name)}`;
    let result = '';
    if (type === 'display') {
        result += `<span class="adcLinkSpan">
               ...
               <a class="tooltip" data-originalvirtualservername="${escapedName}"
               data-loadbalancer="${escapedLoadBalancer}"
                href="${detailsHref}">`;
    }
    result += ruleName;
    if (type === 'display') {
...
function renderMonitor(loadbalancer, name, type) {
    if (name === '') {
        return 'None';
    }
...
function renderPolicy(loadbalancer, name, type) {
    ...
    let result = '';
    const polName = bigipreport_escapeHtml(name.replace(/^\/Common\//, ''));
    const escapedLoadBalancer = bigipreport_escapeHtml(loadbalancer);
    const escapedName = bigipreport_escapeHtml(name);
    const detailsHref = buildJavascriptHref('showPolicyDetails', name, loadbalancer);
    const policyPath = encodeURIComponent(name.replace(/\//g, '~'));
    const editHref = `https://${escapedLoadBalancer}/dms/asm/policies/${policyPath}/general-settings`;
    if (type === 'display') {
        result += `<span class="adcLinkSpan">
                 <a target="_blank"
                 href="${editHref}">
...
function renderPool(loadbalancer, name, type) {
    ...
    const poolName = bigipreport_escapeHtml(name.replace(/^\/Common\//, ''));
    const escapedLoadBalancer = bigipreport_escapeHtml(loadbalancer);
    const escapedName = bigipreport_escapeHtml(name);
    const detailsHref = buildJavascriptHref('showPoolDetails', name, loadbalancer);
    const editHref = `https://${escapedLoadBalancer}/tmui/Control/jspmap/tmui/locallb/pool` +
        `/properties.jsp?name=${encodeURIComponent(name)}`;
    let result = '';
    if (type === 'display') {
        result += `<span class="adcLinkSpan"><a target="_blank"
    href="${editHref}">Edit</a></span>`;
    }
    result += poolStatus(siteData.poolsMap.get(`${loadbalancer}:${name}`), type);
    if (type === 'display') {
        result += `<a class="tooltip" data-originalpoolname="${escapedName}" data-loadbalancer="${escapedLoadBalancer}"
    href="${detailsHref}">`;
    }
    else {
        result += ' ';
...
function renderCertificate(loadbalancer, name, type) {
    let result = bigipreport_escapeHtml(name.replace(/^\/Common\//, ''));
    const escapedLoadBalancer = bigipreport_escapeHtml(loadbalancer);
    const certificateName = name.replace(/\.crt$/, '');
    const editHref = `https://${escapedLoadBalancer}/tmui/Control/jspmap/tmui/locallb/ssl_certificate` +
        `/properties.jsp?certificate_name=${encodeURIComponent(certificateName)}`;
    if (type === 'display') {
        result += `
...
function renderDataGroup(loadbalancer, name, type) {
    const datagroupName = bigipreport_escapeHtml(name.replace(/^\/Common\//, ''));
    const escapedLoadBalancer = bigipreport_escapeHtml(loadbalancer);
    const escapedName = bigipreport_escapeHtml(name);
    const detailsHref = buildJavascriptHref('showDataGroupDetails', name, loadbalancer);
    const editHref = `https://${escapedLoadBalancer}/tmui/Control/jspmap/tmui/locallb/datagroup` +
        `/properties.jsp?name=${encodeURIComponent(name)}`;
    let result = '';
    if (type === 'display') {
        result += `
   ...
   <a class="tooltip" data-originalvirtualservername="${escapedName}" data-loadbalancer="${escapedLoadBalancer}"
       href="${detailsHref}">`;
    }
...
function showVirtualServerDetails(virtualserver, loadbalancer) {
    ...
    if (matchingVirtualServer) {
        ...
        const escapedName = bigipreport_escapeHtml(name);
        const escapedIP = bigipreport_escapeHtml(ip);
        const escapedPort = bigipreport_escapeHtml(port);
        const escapedProfileType = bigipreport_escapeHtml(profiletype);
        const escapedTrafficGroup = bigipreport_escapeHtml(trafficgroup || 'N/A');
        const escapedDescription = bigipreport_escapeHtml(description || '');
        const escapedCompressionProfile = bigipreport_escapeHtml(compressionprofile);
        html = '<div class="virtualserverdetailsheader">';
        html +=
            `<span>Virtual Server: ${escapedName}</span><br>`;
        html +=
            `<span>Load Balancer: ${renderLoadBalancer(loadbalancer, 'display')}</span>`;
        html += '</div>';
        ...
        table += `<table class="virtualserverdetailstable">
                ...
                <tr>
                  <th>IP:Port</th>
                  <td>${escapedIP}:${escapedPort}</td>
                </tr>
                <tr>
                  <th>Profile Type</th>
                  <td>${escapedProfileType}</td>
                </tr>
                <tr>
                  <th>Default pool</th>
                  <td>${renderPool(loadbalancer, defaultPool, 'display')}</td>
                </tr>
                <tr><th>Traffic Group</th><td>${escapedTrafficGroup}</td></tr>
                <tr><th>Description</th><td>${escapedDescription}</td></tr>
            </table>
         </td>`;
        // Subtable 2
        table += `<td>
                <table class="virtualserverdetailstable">
                  <tr>
                    ...
                    <td>${joinEscapedLines(sslprofileclient)}</td>
                  </tr>
                  <tr>
                    <th>Server SSL Profile</th>
                    <td>${joinEscapedLines(sslprofileserver)}</td>
                  </tr>
                  <tr>
                    <th>Compression Profile</th>
                    <td>${escapedCompressionProfile}</td>
                  </tr>
                  <tr>
                    <th>Persistence Profiles</th>
                    <td>${joinEscapedLines(persistence)}</td>
                  </tr>
                  <tr><th>Source Translation</th><td>${bigipreport_escapeHtml(xlate)}</td></tr>
                  <tr>
                    <th>Other Profiles</th>
                    <td>${joinEscapedLines(otherprofiles)}</td>
                  </tr>
                </table>
            </td>
           </tr>
            ...
            if (irules.length > 0) {
                ...
                irules.forEach(iRuleName => {
                    ...
                    if (siteData.preferences.ShowiRuleLinks) {
                            ...
                            if (iRule.datagroups && iRule.datagroups.length > 0) {
                                iRule.datagroups.forEach((datagroup) => {
                                    ...
                                    if (siteData.preferences.ShowDataGroupLinks) {
                                        ...
                                        datagroupdata.push(bigipreport_escapeHtml(dataGroupName));
                                    }
                                });
                            }
                            else {
                        ...
                        table += `        <tr><td>${bigipreport_escapeHtml(iRuleName)}</td></tr>`;
                    }
                });
                table += '</table>';
            }
...
function showiRuleDetails(name, loadbalancer) {
    ...
    if (matchingirule) {
        ...
        html += `<span>iRule: ${bigipreport_escapeHtml(matchingirule.name)}</span><br>`;
        html +=
            `<span>Load Balancer: ${renderLoadBalancer(loadbalancer, 'display')}</span>`;
        html += '</div>';
        ...
        definition = bigipreport_escapeHtml(definition);
        ...
        if (siteData.preferences.ShowDataGroupLinks === true) {
            matchingirule.datagroups.forEach((dg) => {
                ...
                // Prepare the link
                const link = `<a href="${buildJavascriptHref('showDataGroupDetails', dg, loadbalancer)}">$1</a>`;
            ...
            matchingirule.pools.forEach((pool) => {
                ...
                // Prepare the link
                const link = `<a href="${buildJavascriptHref('showPoolDetails', pool, loadbalancer)}">$1</a>`;
                // Do the actual replacement
                definition = definition.replace(regexp, link);
            });
        }
...
function showPolicyDetails(policy, loadbalancer) {
    ...
    if (matchingPolicy) {
        ...
        html = `<div class="policydetailsheader">
               <span>Policy: ${bigipreport_escapeHtml(matchingPolicy.name)} </span>
               <br>
               <span>Load Balancer: ${renderLoadBalancer(loadbalancer, 'display')} </span>
            </div>`;
...
function showDataGroupDetails(datagroup, loadbalancer) {
    ...
    if (matchingDatagroup) {
        ...
        html += `<span>Data group: ${bigipreport_escapeHtml(matchingDatagroup.name)}</span><br>`;
        html +=
            `<span>Load Balancer: ${renderLoadBalancer(loadbalancer, 'display')}</span><br>`;
        html += `<span class="dgtype">Type: ${bigipreport_escapeHtml(matchingDatagroup.type)}</span>`;
        html += '</div>';
                    ...
                    render(data, type) {
                        ...
                        data.split(' ').forEach((item) => {
                            if (type === 'display' && item.match(/^http(s)?:/)) {
                                result.push(`<a href="${bigipreport_escapeHtml(item)}">${bigipreport_escapeHtml(item)}</a>`);
                            }
                            else {
                                ...
                                if (pool) {
                                    ...
                                    result.push(type === 'display' ? bigipreport_escapeHtml(item) : item);
                                }
                            }
                        });
                        return result.join(' ');
